...
namespace Orders
{
    public class OrderService
    {
        ...
        //查询订单
        //按订单号
        public bool findByOrder(string num)
        {
            var m = from o in orders where o.OrderNum == num select o;
            int i = 0;
            foreach (var o in m)
            {
                Console.Write(o.OrderNum + "   " + o.OrderName + "  " + o.OrderPersonPhone + "   " + o.OrderCount + "    " + o.OrderPrice + "\n");
                i++;
            }
            if (i == 0) return false;
            else return true;
        ...
        {
            var m = from o in orders where o.OrderPersonPhone == person select o;
            int i = 0;
            foreach (var o in m)
            {
                Console.Write(o.OrderNum + "   " + o.OrderName + "  " + o.OrderPersonPhone + "   " + o.OrderCount + "    " + o.OrderPrice + "\n");
